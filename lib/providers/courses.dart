import 'dart:convert';
import 'package:skillfloor_lms/models/course.dart';
import 'package:skillfloor_lms/models/course_detail.dart';
import 'package:skillfloor_lms/models/lesson.dart';
import 'package:skillfloor_lms/models/section.dart';
  ...
  List<Course> buildCourseList(List extractedData) {
    ...
    for (var courseData in extractedData) {
      loadedCourses.add(Course(
        ...
        rating:5,
        // totalNumberRating: courseData['cust_review'],
        totalNumberRating: courseData['cust_review'] != null ? int.parse(courseData['cust_review']) : 0,

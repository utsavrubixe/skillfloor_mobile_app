...
#ifndef BACKGROUND_DOWNLOADER_SWIFT_H
#define BACKGROUND_DOWNLOADER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="background_downloader",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC21background_downloader5Chunk")
...
SWIFT_CLASS("_TtC21background_downloader10Downloader")
@interface Downloader : NSObject <FlutterPlugin, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
...
/// If the task requires progress updates, provide these at a reasonable interval
/// If this is the first update for this file, also emit a ‘running’ status update
- (void)URLSession:(NSURLSession * _Nonnull)session task:(NSURLSessionTask * _Nonnull)task didSendBodyData:(int64_t)didSendBodyData totalBytesSent:(int64_t)totalBytesSent totalBytesExpectedToSend:(int64_t)totalBytesExpectedToSend;
...
SWIFT_CLASS("_TtC21background_downloader18ParallelDownloader")
...
SWIFT_CLASS("_TtC21background_downloader8Uploader")
@interface Uploader : NSObject <NSStreamDelegate, NSURLSessionTaskDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

import 'dart:convert';
import 'package:skillfloor_lms/models/bundle.dart';
import 'package:skillfloor_lms/models/bundle_courses_model.dart';
import 'package:skillfloor_lms/models/bundle_details_model.dart';
  ...
  List<Bundle> buildBundleList(List extractedData) {
    ...
    for (var bundleData in extractedData) {
      loadedBundle.add(Bundle(
        ...
        price: bundleData['discounted_price'], //change to discounted price
        ...
        numberOfRatings: bundleData['bundle_review'] != null ? int.parse(bundleData['bundle_review']) : 0,
        // numberOfRatings: int.parse(bundleData['bundle_review']),
        discountedPrice: bundleData['discounted_price'],
        //checking for discounted price in price attribute in bundles @7-5-2024
      ));
      // print(catData['name']);
    }
    return loadedBundle;
    ...
    try {
      ...
      for (var bundleData in extractedData) {
        loadedBundleDetails.add(BundleDetails(
          ...
          courseIds: bundleData['course_ids'],
          subscriptionLimit: bundleData['subscription_limit'],
          price: bundleData['bundle_discounted_price'],
          bundleDetails: bundleData['bundle_details'],
          status: bundleData['status'],
          dateAdded: bundleData['date_added'],
          ...
          discountedPrice: bundleData['bundle_discounted_price'],
          bundleCourses:
